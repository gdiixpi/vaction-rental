...
export class HeaderComponent implements OnInit {
  ...
  //  Validation form
  validationform!: any; // TODO: add type
  signUpform!: any; // TODO: add type
  submit!: boolean;
  formsubmit!: boolean;
 ...
 */
  validSubmit() {
    ...
    this.authService.login(this.validationform.value.email, this.validationform.value.password).subscribe((res: any) => { // TODO: Add type
      console.log(res);
